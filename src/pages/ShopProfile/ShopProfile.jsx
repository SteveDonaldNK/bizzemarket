...
export default function Profile() {
    ...
    function fetchSeller() {
      try {
        axios.get(`http://localhost:4000/api/getseller/${sellerId}`)
        .then((res) => {
    ...
    return (
      <div className={classes.container}>
          <Box className={classes.box} >
              <Avatar src={`http://localhost:4000/api/${sellerData.image}`} className={classes.avatar} sx={{height: 200, width: 200}} />
          </Box>
